...
function createRecipeCards() {
  ...
  for (let i = 0; i < Object.keys(recipeData).length; i++){
    ...
    card.data = recipeData[recipes[i]]//recipeData[recipeData.keys()[i]]
    //console.log(card.data)
    //console.log(recipeData[recipes[i+1]])
    //console.log(recipeData[recipes[i+2]])
